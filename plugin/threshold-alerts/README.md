...
- **Burn-in testing.** Leave running overnight, check the alert log in the morning.
- **Environmental monitoring.** Alert when temperature, humidity, or pressure leaves the safe range.
