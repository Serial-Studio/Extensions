...
The parser maintains state across frames. GGA updates position, altitude, and satellites, while RMC updates speed and course. Both always output all 8 fields.
