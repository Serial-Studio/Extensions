...
| Role | Color | Hex |
|------|-------|-----|
| Background | Deep teal | `#0E161C` |
| Panel | Dark ocean | `#142028` |
| Text | Light cream | `#E8ECF0` |
| Accent | Cyan | `#409DA0` |
| Highlight | Cyan | `#409DA0` |
| Error | Rose | `#D72D60` |
| Console | Mint green | `#8ECD9D` |

## When to Use

For long-time Serial Studio users who remember the original interface, or anyone who likes the character of a purpose-built instrument panel with a hint of retro warmth.
