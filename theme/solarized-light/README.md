...
| Panel | Light tan | `#EEE8D5` |
| Text | Dark teal | `#073642` |
| Accent | Cyan | `#2AA198` |
| Highlight | Blue | `#268BD2` |
| Error | Red | `#DC322F` |
| Console | Dark gray | `#586E75` |

## When to Use

For well-lit environments where a dark theme would look washed out. The warm cream tone is easier on the eyes than pure white, while maintaining excellent readability. Pairs perfectly with Solarized Dark for day/night switching.
