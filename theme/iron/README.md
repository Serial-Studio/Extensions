...
| Accent | Gold | `#E9C979` |
| Highlight | Gold | `#E9C979` |
| Error | Deep red | `#C62828` |
| Console | Dark gray | `#434649` |

## When to Use

Perfect for well-lit workspaces where a dark theme would look washed out. The warm gold accents keep the interface from feeling sterile, while the high contrast ensures every number is instantly readable.
