...
| Role | Color | Hex |
|------|-------|-----|
| Background | Off-white | `#F5F6F7` |
| Toolbar | Slate blue | `#485C76` |
| Text | Near black | `#1E1E1E` |
| Accent | Amber | `#E8A63A` |
| Highlight | Amber | `#E8A63A` |
| Error | Tomato | `#D9534F` |
| Console | Dark text | `#2A2D2F` |

## When to Use

When you want a light theme with more visual personality than plain white. The slate-blue toolbar band gives the interface structure, and the amber accents make interactive elements easy to spot at a glance.
