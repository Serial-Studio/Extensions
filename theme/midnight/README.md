...
| Role | Color | Hex |
|------|-------|-----|
| Background | Near black | `#181a1b` |
| Panel | Dark gray | `#202326` |
| Text | Soft gray | `#b0b3b8` |
| Accent | Indigo | `#4b6cb7` |
| Highlight | Indigo | `#4b6cb7` |
| Error | Salmon | `#e06c75` |
| Console | Sage green | `#98c379` |

## When to Use

The go-to choice for night owls. When the room is dark and the data is flowing, Midnight keeps your eyes comfortable for hours. Pairs well with reduced screen brightness.
